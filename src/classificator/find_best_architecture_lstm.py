"""
Hyperparametersuche für LSTM-Klassifikator
"""
...
def buil_model_lstm(hp):
    ...
    for i in range(hp.Int("lstm_layers", 1, 5)):
        x = keras.layers.LSTM(
            units=hp.Int(f"units_{i}", min_value=24, max_value=64, step=12),
...
if __name__ == "__main__":
    ...
    dir = os.path.join(classificator_dir, "architecture_search_lstm")
    project_name = "lstm"
