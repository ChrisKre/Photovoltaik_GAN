...
if __name__ == "__main__":
    ...
    parser.add_argument("-se", "--season", help="Season", type=str, default="frühling")
    ...
    if fname_fake is None:
        ...
        data_dir_fake = os.path.join(data_dir, season, location)
    ...
    real = dl.get_by_season(real, s)
    fake = fake.iloc[-len(real) :]

    # Set save dir
    f_dir = os.path.join(save_file_dir, season, f"{location}")
