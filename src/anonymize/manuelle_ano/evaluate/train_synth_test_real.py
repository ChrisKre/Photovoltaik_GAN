...
if __name__ == "__main__":
    ...
    df_location["target"] = classification_labels[norm_location]
    ...
    for location_next in locations:
        fname_location = os.path.join(processed_dir, f"{location_next}.csv")
    ...
    file_dir = os.path.join(
        "manuelle_ano", "train_synth_test_real", f"{location}_zu_{norm_location}"
    )
    cl = Classificator(
